...
print("Select your prefered level(It will set the speed of the enemies)")
print("Disclaimer: In level 0, Enemies don't move.\n To stop the game, you have to quit the game manually.\n There is no GAME OVER in level 0")
playsound("Sounds\\intro.wav")
c = int(input("Select your level(level 0 to level 3):"))
if c < 0 or c > 3 :
        print("INVALID LEVEL HAS BEEN CHOSEN.")
